...
creds = ServiceAccountCredentials.from_json_keyfile_name("rolling-admission-ace80259b025.json", scope)
...
# Define these variables with your actual channel/category IDs
...
async def on_ready():
    ...
    try:
        ...
        if submit_channel:
            ...
            logging.error("Submit channel not found.")

        # Verification message setup
